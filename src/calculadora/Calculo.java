...
public class Calculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Montante Inicial");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, jTextField3.getText());
        float montante=Float.parseFloat(jTextField1.getText());
        float taxadejuros=Float.parseFloat(jTextField2.getText());
        int tempo=Integer.parseInt(jTextField3.getText());
        double valorf=montante*Math.pow(1+taxadejuros, tempo);
        
        jLabel4.setText(String.valueOf(valorf));
